...
export function ContactForm({ consultation = false }: { consultation?: boolean }) {
  ...
  return (
    <form className="contact-form" onSubmit={submit} noValidate={false}>
      ...
      {status === "error" && <p className="form-error" role="alert">We couldn&apos;t send your message. Please try again or email <a href="mailto:info@neuraxai.co.uk">info@neuraxai.co.uk</a>.</p>}
